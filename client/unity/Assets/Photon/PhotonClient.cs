...
public class PhotonClient : MonoBehaviour, IPhotonPeerListener 
{
    ...
    /// In this case, we use a LitePeer and make it protected, so not everyone cann directly access it.
    ...
    /// <summary>used as send and dispatch interval. simple but ok for this demo.</summary>
    ...
    // A simpler set of states is enough for this level. A complex game would add it's own, internal state on top.
